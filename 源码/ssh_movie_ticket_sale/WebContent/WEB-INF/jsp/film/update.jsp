...
<body>
<form action="film_exUpdate.do" method="post" class="definewidth m20" id="hh" enctype="multipart/form-data">
<table class="table table-bordered table-hover definewidth m10">
      <tr>
        <td width="10%" class="tableleft">影片编号ID</td>
        <td><input type="text" name="id" id="id" value="${film.id}" disabled="disabled"/>
     ...
     <tr>
        ...
        <td><textarea type="text" name="remark" rows="4" cols="20" id="remark">${film.remark}</textarea></td>
    </tr>
     <tr>
     ...
     <tr>
        ...
        <input type="text" name="startTime" id="startTime" value="${film.startTime}"/></a></td>
    </tr>
     <tr>
        ...
        <input type="text" name="endTime" id="endTime" value="${film.endTime}"/></a></td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">是否推荐</td>
          <td> <input type="radio" name="isRecommend" value="1" <c:if test="${film.isRecommend == 1 }"> checked="checked" </c:if>/>&nbsp;&nbsp;&nbsp;是&nbsp;&nbsp;&nbsp;&nbsp;
          <input type="radio" name="isRecommend" value="0" <c:if test="${film.isRecommend == 0 }"> checked="checked" </c:if>/>&nbsp;&nbsp;&nbsp;否&nbsp;&nbsp;&nbsp;&nbsp;
          </td>
    </tr>
    <tr>
