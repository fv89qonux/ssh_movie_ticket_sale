...
public class OrderItemAction extends ActionSupport implements ModelDriven<OrderItem>{
	...
	public String orderItem(){
		...
		sb = sb.append("from OrderItem where 1=1 ");
		sb = sb.append("order by id desc");
		Pager<OrderItem> pagers = orderItemService.findByAlias(sb.toString(),alias);
		ActionContext.getContext().put("pagers", pagers);
		ActionContext.getContext().put("Obj", orderItem);
		return SUCCESS;
    }
	...
	public String exAdd(){
		...
		ActionContext.getContext().put("url", "/orderItem_orderItem.do");
		return "redirect";
	}
	 ...
	 */
	public String view(){
		OrderItem n = orderItemService.getById(orderItem.getId());
